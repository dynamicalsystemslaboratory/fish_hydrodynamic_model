% this code is modified from main_fit_sheet_simul_v10.m
% major changes: circulation strength is directly associated with mean sheet velocity
% of sheets, which should match speed of fish
% therefore, ciruclation density is determined by sheets separation
...
% dist_sheet = 2*TBA;
% dist_sheet = 5e-3; % separation distance between 2 sheets
...
L_sheet_all = linspace(0.025, L_max, NL);
...
xs_all = linspace(0.07, 0.085, Nxs); % fine

% separation distance
Ndist = 20;
% dist_all = linspace(0, 0.01, Ndist); % coarse
dist_all = linspace(0.001, 0.003, Ndist); % fine
