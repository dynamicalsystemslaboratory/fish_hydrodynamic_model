function [u, v] = func_vortex_velocity_walls(xf, yf, H, Gamma, x, y)
...
u = -(0.25*Gamma/pi)*k*(   sin(k*(  y - yf ))./( denom1 )   -   sin(k*(y-yim))./denom2   ); % velocity along x 

v = (0.25*Gamma/pi)*k*(   sinhkx./( denom1 )   -   sinhkx./denom2   ); % velocity along y
