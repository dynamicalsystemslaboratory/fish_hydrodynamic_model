function [u, v] = func_sheet_pair_velocity_fs_desingul(xf, yf, theta, r0, Gamma, x, y)
...
d4(d4<1e-15) = 1e-15; % if target point is too close to fish location, substitute with a small number to avoid singularity
