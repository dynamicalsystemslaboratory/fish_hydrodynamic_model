...
load('Data_Fig5de.mat', 'x', 'y', 'x_head', 'ys0', 'ys1', 'ys2', 'xs_opt', 'u_opt', 'v_opt', 'u_fish_mean', 'v_fish_mean');
...
U_swim = 0.156379646024586; % m/s; fish fish swimming speed 
...
plot((xs_opt-x_head)/L_tunnel, (ys1-ys0)/L_tunnel, 'kx', 'linewidth',0.5);
plot((xs_opt-x_head)/L_tunnel, (ys2-ys0)/L_tunnel, 'k.', 'markerfacecolor', 'k', 'linewidth', 0.5);
